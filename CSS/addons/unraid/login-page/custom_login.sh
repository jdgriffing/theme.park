...
DOMAIN="github.com/jdgriffing/theme.park/blob/ab3af78dc5897ff4e4eb605822c72541f20fbf31" #if you update the domain after the script has been run, You must disable and re enable JS or the whole theme.  
ADD_JS="false"
